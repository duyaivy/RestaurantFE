...
import { UpdateMeBody, UpdateMeBodyType } from '@/features/accounts/schemas/account.schema'
...
import { useUpdateMeMutation } from '@/features/accounts/hooks/use-account'
                  ...
                  <FormItem>
                    <div className='flex gap-2 items-start justify-start'>
                      <Avatar className='aspect-square w-[100px] h-[100px] rounded-md object-cover'>
                        <AvatarImage key={previewAvatar} src={previewAvatar} />
                      ...
                      <button
                        ...
                        type='button'
                        onClick={() => avaterInputRef.current?.click()}
                      >
