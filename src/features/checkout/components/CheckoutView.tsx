...
import { usePaymentGuestMutation } from "@/features/orders/hooks/use-order";
...
export default function CheckoutView() {
  ...
  return (
    <div className="min-h-screen bg-[#0f0e0c] pb-10">
      {/* HEADER */}
      <div
        className="top-16 z-20 border-b border-[#1e1c18] px-5 py-4"
        style={{ backgroundColor: "#0f0e0c" }}
      >
      ...
      <div className="px-4 pt-5 pb-14 max-w-sm mx-auto flex flex-col gap-4">
        {/* TOTAL */}
        <div
          className="rounded-4xl border border-[#252118] p-5 text-center"
        ...
        {/* PAYMENT METHODS */}
        <div
          className="rounded-4xl border border-[#252118] overflow-hidden"
          style={{ backgroundColor: "#171512" }}
        >
          ...
          <button
            ...
            className={`w-full flex items-center gap-4 px-4 py-4 border-b border-[#1a1816] transition-all ${paymentMethod === PAYMENT_METHOD.QR_CODE
                ? "bg-amber-"
                : "hover:bg-[#1e1c18]"
              }`}
          >
            <div
              className={`w-10 h-10 rounded-xl flex items-center justify-center ${paymentMethod === PAYMENT_METHOD.QR_CODE
                  ? "bg-blue-500"
          ...
          <button
            ...
            className={`w-full flex items-center gap-4 px-4 py-4 transition-all ${paymentMethod === PAYMENT_METHOD.CASH
                ? "bg-amber-"
                : "hover:bg-[#1e1c18]"
              }`}
          >
            <div
              className={`w-10 h-10 rounded-xl flex items-center justify-center ${paymentMethod === PAYMENT_METHOD.CASH
                  ? "bg-green-600"
                  : "bg-[#1e1c18] border border-[#2e2820]"
                }`}
            >
        ...
        {paymentMethod === PAYMENT_METHOD.QR_CODE && (
          <div className="bg-[#171512] rounded-4xl border border-[#252118] p-5">
            ...
            <div
              className="rounded-2xl border border-[#252118] p-4 text-center"
              style={{ backgroundColor: "#0f0e0c" }}
            >
        ...
        <div className="flex gap-3">
          <Link href={ROUTE.GUEST.ORDER_CONFIRMATION} className="flex-1">
            <button
              className="w-full h-12 rounded-2xl border border-[#2a2418] text-white/80 text-[13px] flex items-center justify-center gap-2"
              style={{ backgroundColor: "#171512" }}
            >
