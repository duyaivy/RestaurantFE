...
import { MessageSquare, ChevronRight, ClipboardList, Check } from 'lucide-react'
...
export default function OrderConfirmationPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0f0e0c] pb-36">
      ...
      <div className="px-4 pt-4 max-w-sm mx-auto flex flex-col gap-3">
        ...
        {/* ORDER ITEMS */}
        {items.map((item) => (
          <div key={item.id} className="bg-[#171512] rounded-[20px] border border-[#252118] overflow-hidden">
