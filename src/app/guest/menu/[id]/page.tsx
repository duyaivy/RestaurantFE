...
export default function ProductDetailPage() {
  ...
  const dishesT = useTranslations("dishes");
  ...
  return (
    <div className="min-h-screen bg-[#0a0908] pb-40">
      ...
      <div className="max-w-sm mx-auto px-5 mt-6 space-y-4">
        ...
        <div className="text-center">
          ...
          <div className="mt-3 flex items-center justify-center gap-2">
            ...
            <div className="h-px w-16 bg-linear-to-l from-transparent to-amber-500/30" />
          </div>
        </div>
        ...
        <div className="bg-[#161412] rounded-2xl p-4 border border-white/6">
          ...
          <textarea
            ...
            placeholder={commonT("notePlaceholder")}
            rows={3}
      ...
      {/* Bottom Action Bar */}
      <div className="fixed bottom-16 left-0 right-0 z-30 bg-[#0a0908]/95 backdrop-blur-md border-t border-white/6 px-5 py-4">
