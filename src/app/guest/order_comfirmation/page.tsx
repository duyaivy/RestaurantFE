    ...
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="sticky top-16 z-20 bg-background border-b border-border p-4">
        <div className="flex flex-col gap-2">
          <h1 className="text-xl font-bold text-foreground">Đơn hàng #{orderId?.slice(-5)}</h1>
          <div className="flex items-center gap-2">
            <div className={`px-2 py-1 rounded-full text-xs font-semibold ${
              status === 'confirmed' ? 'bg-orange-500/20 text-orange-600' : 'bg-green-500/20 text-green-600'
            }`}>
      ...
      <div className="fixed bottom-16 left-0 right-0 bg-card border-t border-border p-4">
        <div className="max-w-screen-sm mx-auto space-y-3">
          ...
          <button
            ...
            className="w-full px-4 py-3 rounded-lg bg-orange-600 hover:bg-orange-700 text-white font-semibold transition-colors flex items-center justify-center gap-2"
          >
            Goi nhan vien
          </button>
        </div>
