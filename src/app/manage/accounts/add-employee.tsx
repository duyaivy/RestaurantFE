...
export default function AddEmployee() {
  ...
  const { mutateAsync: addEmployeeMutation, isPending: isAddingEmployee } =
    useAddEmployeeMutation();
  const { mutateAsync: UploadMediaMutation, isPending: isUploadingMedia } =
  ...
  return (
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent className="sm:max-w-150 max-h-screen overflow-auto">
        ...
        <DialogFooter>
          <Button
            isLoading={isAddingEmployee || isUploadingMedia}
            type="submit"
